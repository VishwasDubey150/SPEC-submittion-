...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'who' in question:
        ...
        elif "finger" in question:
            speak("launching finger gesture")
            print("launching finger gesture")
            while (b==True):
                ...
                if len(lm_list) != 0:  # when hand is detected
                    ...
                    if total_fingers_open==1:
                        speak('opening google')
                        print('opening google')
                        webbrowser.open("www.google.com")
                        b=False
                    elif total_fingers_open==2:
                        speak('opening youtube')
                        print('opening youtube')
                        webbrowser.open("youtube.com")
                        b=False
                    elif total_fingers_open==3:
                        speak('opening music')
                        print('opening music')
                        webbrowser.open("https://music.youtube.com/")
                        b=False
                    elif total_fingers_open==4:
                        webbrowser.open("https://mail.google.com/mail/u/1/#inbox")
                        speak("opening gmail")
                        print("opening gmail")
                        b=False
                    elif total_fingers_open==5:
                        speak('opening whattsapp')
                        print('opening whattsapp')
            ...
            speak("launching volume gesture control")
            print("launching volume geture control")
            while (a==True):
